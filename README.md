...
+ Возможность смены имени, фамилии, города, телефона
+ Возможность смены аватарки
- Добавление объявления
- Отображение товара на странице данного пользователя
- Страница товара (отображение)
- Редактирование объявления
- Возможность снять обьявление с публикации
+ Добавление отзывов о товаре
- Валидация и обработка ошибок при регистрации
- Валидация и обработка ошибок при регистрации
